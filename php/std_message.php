 ...
 include 'db_connection.php';
  $sql= mysqli_query($mysqli, "update discussion set status='read' where staff_id='$staff_id' && sender='supervisor'");
  ?>
<html>
    <head>
<!--         <meta http-equiv="refresh" content="5" />-->
         <title>PMS: Discussion page</title></head>
    <body >
        <?php
...
echo'<textarea name="CRmsg" rows="3" cols="40" style="color:#333;border:0px;border-radius:2em; float:left; background-color:lightgray;padding:5px">'.$message['time'].":--->".str_replace("_","'",$message['message']).'</textarea><br><br><br><br>';
